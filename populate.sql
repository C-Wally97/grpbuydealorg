...
/* myPassword1, etc */
insert into Users(Email, Password, Name, Product_rating_weight, Supplier_rating_weight, Time_weight) values("myEmail1@domain.com", "aa7124220a41cca0c0d8a105bf5483fa", "A guy1", 0, 100, 0);
insert into Users(Email, Password, Name, Product_rating_weight, Supplier_rating_weight, Time_weight) values("myEmail2@domain.com", "8ff9406be0e00f91d777b3aa2a198bf0", "A guy1", 50, 0, 50);
